...
class UTM:
    ...
    def __init__(self, simulated_machine_description, simulated_machine_tape, simulated_machine_condition, infinity_buffer_size, implicit_quintuples=True, dangerous_quintuples=False, verbosity=1):
        ...
        self.tape = Tape(list("0"*infinity_buffer_size + simulated_machine_tape + "M000Y" + simulated_machine_condition + simulated_machine_description + "Y" + "0"*infinity_buffer_size), \
            infinity_buffer_size + len(simulated_machine_tape) + 5 + len(simulated_machine_condition))
